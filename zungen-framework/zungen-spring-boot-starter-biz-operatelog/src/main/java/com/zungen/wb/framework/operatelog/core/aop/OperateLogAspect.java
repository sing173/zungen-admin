package com.zungen.wb.framework.operatelog.core.aop;
...
import com.zungen.wb.framework.common.util.monitor.TracerUtils;
import com.zungen.wb.framework.common.util.servlet.ServletUtils;
import com.zungen.wb.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.zungen.wb.framework.web.core.util.WebFrameworkUtils;
...
import static com.zungen.wb.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.zungen.wb.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, ApiOperation apiOperation) throws Throwable {
        ...
        com.zungen.wb.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.zungen.wb.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.zungen.wb.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.zungen.wb.framework.operatelog.core.annotations.OperateLog operateLog,
