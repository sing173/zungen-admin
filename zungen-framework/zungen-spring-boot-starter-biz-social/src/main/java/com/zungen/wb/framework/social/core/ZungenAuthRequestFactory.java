package com.zungen.wb.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.zungen.wb.framework.social.core.enums.AuthExtendSource;
import com.zungen.wb.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class ZungenAuthRequestFactory extends AuthRequestFactory {
    ...
    public ZungenAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
