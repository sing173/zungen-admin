package com.zungen.wb.framework.file.core.client.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.zungen.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.zungen.iocoder.cn
        // 默认上海的 endpoint
