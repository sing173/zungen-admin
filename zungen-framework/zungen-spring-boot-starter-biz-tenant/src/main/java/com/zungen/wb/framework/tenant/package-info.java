 ...
 *      1）Spring Async：
 *          {@link com.zungen.wb.framework.quartz.config.ZungenAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ZungenSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.zungen.wb.framework.tenant;
