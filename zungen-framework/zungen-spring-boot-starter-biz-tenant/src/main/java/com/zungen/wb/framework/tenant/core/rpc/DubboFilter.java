package com.zungen.wb.framework.tenant.core.rpc;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.util.StrUtil;
import com.zungen.wb.framework.common.exception.ServerException;
import com.zungen.wb.framework.common.exception.ServiceException;
...
import static com.zungen.wb.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.zungen.wb.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.zungen.wb.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.zungen.wb.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;


@Activate(group = {CommonConstants.PROVIDER, CommonConstants.CONSUMER}) // TODO 优化点：设置下顺序
@Slf4j
public class DubboFilter implements Filter, Filter.Listener  {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if(StrUtil.isNotEmpty(tenantId)) {
            ...
            RpcContext.getContext().setAttachment(HEADER_TENANT_ID, TenantContextHolder.getRequiredTenantId().toString());
        }
