package com.zungen.wb.framework.tracer.config;

import com.zungen.wb.framework.common.enums.WebFilterOrderEnum;
import com.zungen.wb.framework.tracer.core.aop.BizTraceAspect;
import com.zungen.wb.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zungen.tracer", value = "enable", matchIfMissing = true)
public class ZungenTracerAutoConfiguration {
