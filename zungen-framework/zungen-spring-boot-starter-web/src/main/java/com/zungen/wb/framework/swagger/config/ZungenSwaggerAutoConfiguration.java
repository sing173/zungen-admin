package com.zungen.wb.framework.swagger.config;

import com.zungen.wb.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
@ConditionalOnProperty(prefix = "zungen.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class ZungenSwaggerAutoConfiguration {
...
//                .apis(basePackage("com.zungen.wb.module.system")) // 可用于 swagger 无法展示时使用
