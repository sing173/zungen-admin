package com.zungen.wb.module.system.service.user;
...
import com.zungen.wb.module.system.controller.admin.user.vo.user.*;
...
import com.zungen.wb.module.system.dal.mysql.dept.UserPostMapper;
import com.zungen.wb.module.system.dal.mysql.user.AdminUserMapper;
import com.zungen.wb.module.system.enums.common.SexEnum;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zungenyuanma");
        ...
        assertEquals("zungenyuanma", user.getPassword());
    ...
    public void testImportUsers_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zungenyuanma"))).thenReturn("java");
