package com.zungen.wb.module.system.controller.admin.user.vo.user;
...
public class UserBaseVO {
    ...
    @ApiModelProperty(value = "用户账号", required = true, example = "zungen")
    ...
    @ApiModelProperty(value = "用户邮箱", example = "zungen@iocoder.cn")
