package com.zungen.wb.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelBaseVO {
    ...
    @ApiModelProperty(value = "短信签名", required = true, example = "admin")
    ...
    @ApiModelProperty(value = "短信 API 的账号", required = true, example = "zungen")
