package com.zungen.wb.module.system.service.social;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import com.zungen.wb.framework.common.util.http.HttpUtils;
...
import com.zungen.wb.module.system.dal.dataobject.social.SocialUserBindDO;
import com.zungen.wb.module.system.dal.dataobject.social.SocialUserDO;
import com.zungen.wb.module.system.dal.mysql.social.SocialUserBindMapper;
import com.zungen.wb.module.system.dal.mysql.social.SocialUserMapper;
import com.zungen.wb.module.system.enums.social.SocialTypeEnum;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 ZungenAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private ZungenAuthRequestFactory zungenAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = zungenAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
