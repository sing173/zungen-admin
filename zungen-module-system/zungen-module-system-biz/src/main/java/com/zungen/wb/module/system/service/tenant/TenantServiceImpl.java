package com.zungen.wb.module.system.service.tenant;
...
import com.zungen.wb.framework.tenant.config.TenantProperties;
import com.zungen.wb.framework.tenant.core.context.TenantContextHolder;
import com.zungen.wb.framework.tenant.core.util.TenantUtils;
import com.zungen.wb.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import com.zungen.wb.module.system.convert.tenant.TenantConvert;
...
import com.zungen.wb.module.system.dal.mysql.tenant.TenantMapper;
import com.zungen.wb.module.system.enums.permission.RoleCodeEnum;
import com.zungen.wb.module.system.enums.permission.RoleTypeEnum;
...
import com.zungen.wb.module.system.service.tenant.handler.TenantInfoHandler;
import com.zungen.wb.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 zungen.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
