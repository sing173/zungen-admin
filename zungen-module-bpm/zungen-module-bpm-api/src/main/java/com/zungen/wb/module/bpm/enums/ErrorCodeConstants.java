package com.zungen.wb.module.bpm.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 贷款人信息 1-009-012-000 ==========
    ErrorCode LOAN_USER_NOT_EXISTS = new ErrorCode(1009012000, "贷款人信息不存在");
    ErrorCode LOAN_IDENTITY_NOT_EXISTS = new ErrorCode(1009012001, "身份认证信息不存在");
    ErrorCode LOAN_CONTACT_NOT_EXISTS = new ErrorCode(1009012002, "联系人不存在");
    ErrorCode LOAN_GUARANTEE_NOT_EXISTS = new ErrorCode(1009012003, "担保信息不存在");
    ErrorCode LOAN_ORDER_NOT_EXISTS = new ErrorCode(1009012002, "贷款工单不存在");
    ErrorCode LOAN_PRODUCT_NOT_EXISTS = new ErrorCode(1009012003, "贷款产品不存在");
