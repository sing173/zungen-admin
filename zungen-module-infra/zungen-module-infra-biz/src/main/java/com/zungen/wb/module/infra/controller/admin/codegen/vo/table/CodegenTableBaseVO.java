package com.zungen.wb.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableBaseVO {
    ...
    @ApiModelProperty(value = "表名称", required = true, example = "zungen")
    ...
    @ApiModelProperty(value = "作者", required = true, example = "admin")
