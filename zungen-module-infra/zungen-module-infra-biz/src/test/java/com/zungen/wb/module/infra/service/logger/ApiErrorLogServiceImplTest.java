...
import com.zungen.wb.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.zungen.wb.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.zungen.wb.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.zungen.wb.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.zungen.wb.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.zungen.wb.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.zungen.wb.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        String applicationName = "zungen-test";
