...
* 演示地址：<http://dashboard.zungen.iocoder.cn>
...
| `zungen-cloud`  | Spring Cloud 微服务       | **[Gitee](https://gitee.com/zhijiantianya/zungen-cloud)** &nbsp;&nbsp;&nbsp; [Github](https://github.com/YunaiV/zungen-cloud)         |
...
| 项目                    | 说明                 |
|-----------------------|--------------------|
| `zungen-dependencies`  | Maven 依赖版本管理       |
| `zungen-framework`     | Java 框架拓展          |
| `zungen-server`        | 管理后台 + 用户 APP 的服务端 |
| `zungen-ui-admin`      | 管理后台的 Vue2 前端项目        |
| `zungen-ui-admin-vue3`      | 管理后台的 Vue3 前端项目        |
| `zungen-ui-admin-uniapp`      | 管理后台的 uni-app 多端项目        |
| `zungen-ui-app`       | 用户 APP 的 UI 界面     |
| `zungen-module-system` | 系统功能的 Module 模块    |
| `zungen-module-member` | 会员中心的 Module 模块    |
| `zungen-module-infra`  | 基础设施的 Module 模块    |
| `zungen-module-tool`   | 研发工具的 Module 模块    |
| `zungen-module-bpm`    | 工作流程的 Module 模块    |
| `zungen-module-pay`    | 支付系统的 Module 模块    |
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件     | 1.2.11    | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?zungen) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包       | 3.5.2    | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?zungen)         |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源               | 3.5.0    | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?zungen) |
| [Redis](https://redis.io/)                                                                  | key-value 数据库        | 5.0      |                                                                |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端            | 3.17.4   | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?zungen)           |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架               | 5.3.20    | [文档](http://www.iocoder.cn/SpringMVC/MVC/?zungen)               |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架         | 5.6.5    | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?zungen) |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件             | 6.2.3    | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?zungen)      |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎               | 6.7.0    | [文档](https://doc.iocoder.cn/bpm/)                                                     |
| [Quartz](https://github.com/quartz-scheduler)                                               | 任务调度组件             | 2.3.2    | [文档](http://www.iocoder.cn/Spring-Boot/Job/?zungen)             |
| [Knife4j](https://gitee.com/xiaoym/knife4j)                                                 | Swagger 增强 UI 实现    | 3.0.3    | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?zungen)         |
| [Resilience4j](https://github.com/resilience4j/resilience4j)                                | 服务保障组件             | 1.7.1    | [文档](http://www.iocoder.cn/Spring-Boot/Resilience4j/?zungen)    |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.5.0    | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?zungen)      |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台    | 2.6.7    | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?zungen)           |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库             | 2.13.3   |                                                                |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换         | 1.4.1    | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?zungen)       |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码     | 1.16.14  | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?zungen)          |
| [JUnit](https://junit.org/junit5/)                                                          | Java 单元测试框架        | 5.8.2    | -                                                              |
| [Mockito](https://github.com/mockito/mockito)                                               | Java Mock 框架         | 4.0.0    | -                                                              |

### [管理后台 Vue2 前端](./zungen-ui-admin)
...
### [管理后台 Vue3 前端](./zungen-ui-admin-vue3)
...
### [管理后台 uni-app 跨端](./zungen-ui-admin-uniapp)
