package com.zungen.wb.module.member.service.user;
...
import com.zungen.wb.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, ZungenRedisAutoConfiguration.class})
